...
public class H2DataSourceConfiguration {
	...
	public DataSource integrationLayerDataSource() {
		...
		dataSource.setUrl("jdbc:h2:tcp://localhost:9099/mem:spm;DB_CLOSE_DELAY=-1;DB_CLOSE_ON_EXIT=FALSE");
